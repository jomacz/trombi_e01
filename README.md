<details>
<summary>E01 - Gestion de projet & Architecture</summary>
...
<details>
<summary>E03 - PotgresSQL at Home </summary>

# E03 - PostgresSQL at Home
...
<details>
<summary>E04 - ExpresSQL et DataMapper</summary>

# E04 - ExpresSQL et DataMapper
...
<details>
<summary>E05 - Cookies et Session</summary>

# E05 - Cookies et Session
...
- un bout de texte au format name=value
- modifiable par le front (client) ET le back (serveur)
- fiable: envoyé au serveur à chaque requête (sans aucune exception)
- non sécurisé: lisible et totalement modifiable par l'utilisateur


Une session c'est:

- stocké par le serveur
- identifié par un token unique confié au client (dans un cookie)
- sécurisé: innaccessible aux utilisateurs
- fiable: repose uniquement sur le principe des cookie, lui-même fiable
